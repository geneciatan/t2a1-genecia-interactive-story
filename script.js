...
const introStoryPanels = [
  ...
  },
  {
    ...
    content:
      "Alex is a college student who loves social media and online gaming. Sarah is Alex's best friend who works in marketing. Maya is a cybersecurity expert who specializes in AI threats. Together, they'll help you learn to identify and respond to AI-generated deception.",
  },
  {
...
const storyScenes = [
  {
    ...
    minigameData: {
      ...
      spots: [
        { x: 38, y: 138, description: "Digital artifacts and pixelation around the left jawline edge" },
        { x: 136, y: 72, description: "Unnatural jagged edges on the right side of the face" },
        { x: 166, y: 124, description: "Eyes appear too symmetrical and lack natural asymmetry" },
      ],
    },
    educational:
  ...
  },
  {
    ...
    minigameData: {
      ...
      spots: [
        { x: 101, y: 95, description: "Mouth and teeth appear artificially generated with unnatural alignment" },
        { x: 82, y: 66, description: "Left eye has inconsistent lighting compared to the right eye" },
        { x: 111, y: 112, description: "Facial hair has digital artifacts and unnatural texture patterns" },
      ],
    },
    educational:
  ...
  },
  {
    ...
    minigameData: {
      ...
      spots: [
        { x: 98, y: 40, description: "Face appears too smooth and perfect - lacks natural skin texture" },
        { x: 53, y: 73, description: "Left ear has unnatural shading and artificial appearance" },
        { x: 119, y: 96, description: "Right side of face shows perfect symmetry - too artificial for real photo" },
      ],
    },
    educational:
